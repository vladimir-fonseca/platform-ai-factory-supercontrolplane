...
-->
# kubeadm-controlplane-template/values

This child module currently uses authored Cluster API YAML only.

Keep future shared parameters, rendered patches, or environment-specific defaults
here if this module becomes templated later.
